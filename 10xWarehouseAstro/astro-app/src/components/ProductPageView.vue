      ...
      <div class="mb-8">
        <div class="flex items-center justify-between">
          ...
          <div v-if="productStore.canCreateProduct" class="flex items-center space-x-4">
            <Button id="CreateProduct" @click="uiStore.openCreateProductModal()">
        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <input
              ...
              class="block w-full pl-10 pr-3 py-2 border border-input rounded-md leading-5 bg-background text-foreground placeholder-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring sm:text-sm"
            />
          </div>
        </div>
      </div>
