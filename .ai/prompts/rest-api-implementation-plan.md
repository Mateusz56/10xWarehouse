...
3. Type definitions:
<type_definitions>
{{types}} <- replace with reference to type definitions 10xWarehouseNet/Dtos
</type_definitions>
...
Remember to save your implementation plan as .ai/{short endpoint description (e.g. get-organizations)}endpoint-implementation-plan.md. Ensure the plan is detailed, clear, and provides comprehensive guidance for the development team.